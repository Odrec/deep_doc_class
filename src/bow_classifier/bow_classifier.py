...
#        '''
#        Computes the prediction probability for the input string. 
#        If the probability is inside the specified lower and upper bound the value 
#        is considered to be not specific enough and is changed to 0.5
#
...
#            clean_test_data = cbd.preprocess_pdf_metadata_string(input_string)
#        elif(self.data_origin == "pdfinfo"):
#            clean_test_data = cbd.preprocess_pdf_property_string(input_string)
#        else:
#            clean_test_data = cbd.preprocess_pdf_text_string(input_string)
#
