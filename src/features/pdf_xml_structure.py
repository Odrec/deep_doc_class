...
from os.path import join, realpath, basename, isfile, splitext
...
class Document(object):
    ...
    def get_feature_dict(self):
        features = {
            ...
            "smallest_image":0,             # smallest image
...
#            "last_100_words":"",
            ...
            #ADDED
            "total_textbox_space":0,
            "mean_lines_per_textbox":0,
            "dev_lines_per_textbox":0,
            "max_lines_per_textbox":0,
            "total_blockstyle_space":0,
        ...
        if(len(self.images["pathes"])>0):
            ...
            features["smallest_image"] = min(self.images["sizes"])
            ...
            # print("smallest_image: " + str(features["smallest_image"]))
...
def proc_xml_wrap(doc):
    return doc.process_xml(img_flag=False)

def get_structure_features(file):
    doc = Document(file)
...
def pre_extract_pdf_structure_data(batch_files, num_cores=1):
