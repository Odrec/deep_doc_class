...
class Document(object):
    ...
    def update_page_stats(self, page):
        ...
        # print(page.space)
        # print(page.image_space)
        # print(self.stat_lists["blockstyle_space_pp"][-1])
        # print(self.stat_lists["textbox_space_pp"][-1])
        self.stat_lists["page_space_pp"].append(page.space)
        self.stat_lists["image_space_pp"].append(page.image_space)
        # if(page.space-page.image_space-self.stat_lists["blockstyle_space_pp"][-1]-self.stat_lists["textbox_space_pp"][-1]+text_img_overlap<0):
        #     self.stat_lists["free_space_pp"].append(0)
        # else:
