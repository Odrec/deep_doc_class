...
def get_data_vector(t_data):
    ...
    if TRAINING:
        ...
        METADATA = MetaHandler.get_classified_meta_dataframe(join(DATA_PATH,"classified_metadata.csv"))
        PDF_PATH = os.path.dirname(os.path.abspath(t_data))
        doc_id = os.path.splitext(t_data)[0]
