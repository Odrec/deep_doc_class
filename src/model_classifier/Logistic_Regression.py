...
class Logistic_Regression(Classifier):
    ...
    def __init__(self,**kwargs):
        '''
        Initializes a sklearn.linear_model.LogisticRegression classifier using all the parameters specified in kwargs. The parameters have to parameters which can be handled by the sklearn library and must consist at least in those parameters necessary to create a model.
